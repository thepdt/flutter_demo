...
class AddToCartAnimationOverlay extends StatefulWidget {
  ...
  AddToCartAnimationOverlay(
      {@required this.start, @required this.end, this.overlayWidget});

  @override
  _AddToCartAnimationOverlayState createState() =>
...
class _AddToCartAnimationOverlayState extends State<AddToCartAnimationOverlay>
  ...
  Path drawPath() {
    ...
    path.quadraticBezierTo(
        widget.end.left * 0.5, widget.end.top, widget.end.left, widget.end.top);
    return path;
  }
