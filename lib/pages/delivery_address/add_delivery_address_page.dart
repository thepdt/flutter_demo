...
import 'package:flutter_demo/widgets/google_map/custom_google_map.dart';
...
class _AddDeliveryAddressPageState extends State<AddDeliveryAddressPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          constraints:
              BoxConstraints(minHeight: ScreenHelper.getSafeHeight(context)),
      ...
      child: RaisedButton(
        ...
        onPressed: () async {
          if (onValidName() == null &&
            ...
            var rs = await DeliveryAddressService()
